//
//  CommnetDetailTableViewController.swift
//  12a.m.
//
...
class CommnetDetailTableViewController: UITableViewController, UITextFieldDelegate, CommentUpdatedToDelegate, CommentDetailTableViewCellDelegate {
   ...
   internal func didPressBlockButton(_ sender: CommentDetailTableViewCell) {
        blockUserActionSheet()
    }
    
   internal func didPressUserInfo(_ sender: CommentDetailTableViewCell) {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "commentCell2", for: indexPath) as? CommentDetailTableViewCell else { return UITableViewCell() }
...
extension CommnetDetailTableViewController {
